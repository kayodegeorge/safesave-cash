    ...
    <>
      <div className='px-10 sm:px-20'>
        ...
        <form
          ...
          className='bg-white shadow-md rounded-lg px-24 pt-14 pb-8 mb-4 mt-4'
        >
          <div className='mb-4 relative'>
            <h1 className='text-gray-700 flex justify-center text-center mb-3 font-bold text-lg'>
              Welcome Back
            </h1>
          ...
          <p
            ...
            className='text-sm text-center pt-4 text-gray-700 gap-4'
          >
